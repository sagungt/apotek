        ...
        <form wire:submit.prevent="submit">
            ...
            >
                ...
                <x-adminlte-input
                    ...
                    label="Isi per box"
                    placeholder="Jumlah"
                    wire:model.defer="newMedicine.isi_box"
                    error-key="newMedicine.isi_box"
                >
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
                            <i class="fas fa-capsules"></i>
                ...
                <x-adminlte-input
                    ...
                    label="Harga per box"
                    placeholder="Harga"
                    wire:model.defer="newMedicine.harga_per_box"
                    error-key="newMedicine.harga_per_box"
                >
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
                ...
                <x-adminlte-input
                    ...
                    label="Margin (%)"
                    placeholder="Margin"
                    wire:model.defer="newMedicine.margin"
                    error-key="newMedicine.margin"
                >
                    <x-slot name="prependSlot">
                        <div class="input-group-text">
